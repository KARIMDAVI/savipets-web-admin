 ...
 * 
 * Calendar view for displaying bookings in a monthly calendar format.
 */
...
export const CalendarView: React.FC<CalendarViewProps> = ({
  ...
  const getBookingsForMonth = (date: Dayjs) => {
    return bookings.filter(booking => {
    ...
    return (
      <div style={{ marginTop: '24px' }}>
        <div style={{ 
          ...
          <h3 style={{ margin: 0, fontSize: '20px', fontWeight: 500, lineHeight: '28px' }}>
